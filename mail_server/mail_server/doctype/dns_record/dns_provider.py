...
class BaseDNSProvider(ABC):
	...
	@abstractmethod
	def create_dns_record(self, domain: str, type: str, host: str, value: str, ttl: int) -> bool:
...
class DNSProvider:
	...
	def create_or_update_dns_record(self, domain: str, type: str, host: str, value: str, ttl: int) -> bool:
